...
namespace scoreBatch
{
    ...
    class Program
    {
        ...
        static async Task InvokeBatchExecutionService()
        {
            ...
            UploadFileToBlob("C:\\Users\\srram\\Desktop\\input1data.csv" /*Replace this with the location of your input file*/,
            ...
            using (HttpClient client = new HttpClient())
            {
                ...
                while (!done)
                {
                    ...
                    if (done)
                    {
                        Thread.Sleep(100000); // Wait one second
